#!/usr/bin/env python
"""
Standalone migration script SQLite to PostgreSQL
This script works independently without any external files
"""
...
os.environ['SECRET_KEY'] = '9gP4H3fKx7LQvNM2szRJb8WYtUoAcVjdDfZae5l0XhkqE1TrS9'
